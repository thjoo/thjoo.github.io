import{a8 as P,b as T}from"./app-core.fa86622d.js";import{_ as d}from"./vendor-other.835e467b.js";import{n as x,an as g,f as C,i as A,j as M,a0 as _,R as y,Q as N,T as k,M as R,ae as W,U as O,P as H,ax as j}from"./vendor-vue-ui.ad4935f9.js";import{_ as G}from"./Button.aa421c00.js";import{B as D}from"./Img.93307c5c.js";import{B as J}from"./Input.a5933210.js";import{S as q}from"./Plus.67d59660.js";import{_ as Y}from"./Trash.49bbc1a8.js";import{_ as F}from"./_plugin-vue_export-helper.eefbdd86.js";const b="all-in-one-seo-pack",L=()=>typeof window.wp?.media=="function"?window.wp.media:typeof window.parent?.wp?.media=="function"?window.parent.wp.media:null,Q=()=>{let e=null;const n=({title:i,buttonText:a,multiple:s=!1,type:r=null,onSelect:c})=>{e=L()({title:i,button:{text:a},multiple:s,library:r?{type:r}:{}}),e.on("select",()=>{const u=e.state().get("selection"),l=u.first();l&&c(s?u.toJSON():l.toJSON())}),e.on("close",()=>e.detach()),x(()=>{e.open()})},t=({multiple:i=!1,type:a=null,onSelect:s})=>{const u=(T().aioseo?.urls?.home||window.location.origin).replace(/\/$/,"")+"/wp-admin/",l=new URLSearchParams({breakdance_wpuiforbuilder_media:"1"});a&&l.set("types",a),i&&l.set("multiple","1");const o=document.createElement("div");if(o.className="aioseo-media-uploader-overlay",o.innerHTML=`
