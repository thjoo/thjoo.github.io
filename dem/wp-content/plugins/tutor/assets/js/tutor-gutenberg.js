...
(()=>{e.ruid="bundler=rspack@1.6.5"})();// CONCATENATED MODULE: external "wp.i18n"
const n=wp.i18n;// CONCATENATED MODULE: ./assets/src/js/gutenberg/custom-button.js
/**
...
})(window,wp);// CONCATENATED MODULE: ./assets/src/js/gutenberg/index.js
})();